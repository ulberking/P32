...
var engine, world;
var ground, stand, box1,box2,box3,box4,box5,box6,connect,polygon,bg
function preload(){
backchange()
}
function setup() {
...
async function backchange(){
  var call = await fetch("http://worldclockapi.com/api/json/est/now");
  var jsoncall = await call.json();
  var day = jsoncall.currentDateTime;
